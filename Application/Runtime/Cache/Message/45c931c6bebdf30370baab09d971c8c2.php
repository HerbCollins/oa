    ...
    <div class="main person">
        <div class="contain">
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('Message/index/index');?>"><i class="icon icon-list"></i> 消息列表</a></li>
                <li>消息详情</li>
            </ol>
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="container">
                        <article class="article">
                          <header>
                            <h1 class="text-center"><?php echo ($detail["title"]); ?></h1>
                            <dl class="dl-inline">
                              <dt>来自：</dt>
                              <dd><?php echo (getUserName($detail["from_uid"])); ?></dd>
                              <dt>发送给：</dt>
                              <dd><?php echo (getUserName($detail["to_uid"])); ?></dd>
                              <dt>时间：</dt>
                              <dd><?php echo ($detail["time"]); ?></dd>
                            </dl> 
                          </header>
                          <section class="content">
                            <?php echo (htmlspecialchars_decode(stripslashes($detail["content"]))); ?>
                          </section>
                          <footer>
