				...
				<div class="contain">
					...
					<table class="table text-center table-striped table-hover">
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>-</td>
								<td>-</td>
								<td><button class="btn btn-info" onclick="check(this,<?php echo ($vo['id']); ?>,<?php echo ($vo['number']); ?>,<?php echo ($vo['tid']); ?>)">批准</button><button class="btn btn-danger" onclick="reject(this,<?php echo ($vo['id']); ?>)">驳回</button></td>
